#!/usr/bin/env python
"""Query script for the MathRAG MCP Server.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Query documents from the MathRAG knowledge hub.",
...
def main() -> int:
    ensure_expected_venv("scripts/query.py")
    args = parse_args()
