...
Write-Host "  1. Create public Gradio Space on modelscope.cn (e.g. KUNNventure/MathAsk)"
Write-Host "  2. git clone https://www.modelscope.cn/studios/KUNNventure/MathAsk.git"
