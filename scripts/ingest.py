#!/usr/bin/env python
"""Ingestion script for the MathRAG MCP Server.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Ingest documents into the MathRAG knowledge hub.",
    ...
    parser.add_argument(
        "--grade", "-g",
        default=None,
        help="Grade level metadata (e.g. '7', '8', '9') for textbook chunking"
    )

    parser.add_argument(
        "--volume", "-V",
        default=None,
        help="Volume metadata (e.g. '上册', '下册') for textbook chunking"
    )
...
def main() -> int:
    ...
    """
    ensure_expected_venv("scripts/ingest.py")
    args = parse_args()
    ...
    print("[*] MathRAG Ingestion Script")
    print("=" * 60)
