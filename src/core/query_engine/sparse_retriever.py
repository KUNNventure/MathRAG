...
class SparseRetriever:
    ...
    def __init__(
        ...
        # BM25Indexer.load() replaces in-memory index; concurrent retrieve() must not
        # interleave load/query (e.g. EvalRunner workers>1 or HybridSearch parallel paths).
    ...
    def retrieve(
        ...
        # Step 1–2: Load + query must be atomic w.r.t. other threads sharing this indexer.
